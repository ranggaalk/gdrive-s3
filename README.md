...
| Multipart upload, `CopyObject` (same actor) | SSE-KMS and server-side encryption |
| SigV4 header and presigned-query auth | Cross-user `CopyObject` between unrelated My Drive accounts |
