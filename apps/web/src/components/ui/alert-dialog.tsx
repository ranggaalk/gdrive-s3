...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Same viewport cap as DialogContent: a long confirmation body must
        // scroll inside the panel rather than push the action buttons off
        // screen. See ui/dialog.tsx for the reasoning.
